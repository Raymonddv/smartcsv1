...
@foreach ($places as $Place)
    <h4 id="scoreTitle">Geef hieronder aan welke van onderstaande vijf beoordelingspunten ervoor zorgen dat {{$Place->place_2}} tot jouw favorieten behoort. Na het aanvinken verschijnt een schuifbalk. Geef hiermee aan in welke mate je tevreden bent over het betreffende beoordelingspunt.
@endforeach
    <!-- Restaurant # --></h4>
...
<!--     <h3>Uw score voor</h3> -->
    ...
    <div id="dvScore_1" style="display: none">
        <input type="range" name="place_2_kwaliteit_eten" max="10" min="0" step="1" value="" disabled="disabled">
    ...
    <div id="dvScore_2" style="display: none">
        <input type="range" name="place_2_prijs_kwaliteit" max="10" min="0" step="1" value="" disabled="disabled">
    ...
    <div id="dvScore_3" style="display: none">
        <input type="range" name="place_2_variatie" max="10" min="0" step="1" value="" disabled="disabled">
    ...
    <div id="dvScore_4" style="display: none">
        <input type="range" name="place_2_sfeer" max="10" min="0" step="1" value="" disabled="disabled">
    ...
    <div id="dvScore_5" style="display: none">
        <input type="range" name="place_2_service" max="10" min="0" step="1" value="" disabled="disabled">
