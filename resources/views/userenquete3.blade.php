...
@foreach ($places as $Place)
    <h3 id="scoreTitle">Geef hieronder aan welke van onderstaande vijf beoordelingspunten ervoor zorgen dat {{$Place->place_3}} tot jouw favorieten behoort. Na het aanvinken verschijnt een schuifbalk. Geef hiermee aan in welke mate je tevreden bent over het betreffende beoordelingspunt.
    </h3>
@endforeach
